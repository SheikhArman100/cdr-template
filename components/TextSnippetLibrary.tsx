            ...
            <CardContent className="p-5">
              <div className="flex flex-col-reverse justify-start items-start gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border text-sm text-gray-700 whitespace-pre-wrap font-mono">
                    {snippet.text}
                  </div>
                </div>
      ...
      {textSnippets.length === 0 && (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <CardTitle className="text-lg text-gray-900 mb-2">No text snippets</CardTitle>
